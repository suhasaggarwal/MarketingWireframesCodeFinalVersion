...
public class ReportRestController {
	...
	public ResponseEntity<String> getReport(@PathVariable("QueryField") String queryfield,
		...
		String report = reportService.extractReports(queryfield,metric,dateRange,campaignId,channel,aggregate,ratiometric);
		if (report == null) {
	...
	@RequestMapping(value = "/report/{QueryField}/downloadCSV", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	@CrossOrigin
